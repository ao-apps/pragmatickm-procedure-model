...
package com.pragmatickm.procedure.model.book;
...
@WebServlet("/procedure/model/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		HttpServletUtil.sendRedirect(
			...
			"/procedure/model/apidocs/com.pragmatickm.procedure.model/com" + Objects.toString(req.getPathInfo(), ""),
